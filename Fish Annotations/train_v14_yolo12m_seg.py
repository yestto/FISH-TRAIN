"""
train_v14_yolo12m_seg.py
=========================
YOLO12m SEGMENTATION at imgsz=1280.
Requires segmentation labels from: convert_bbox_to_seg.py
Expected: mAP50-95 ~96-98%.
Run AFTER train_v14_yolo11m_seg.py completes.
"""
...
RUN_NAME      = "fish_yolo12m_seg_1280"

def main():
    print("=== YOLO12m-seg Training at imgsz=1280 ===")
